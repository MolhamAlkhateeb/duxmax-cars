    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Browse our network of trusted and verified car dealers across the UAE
        </p>
      </div>
      ...
      <div className="mb-8">
        <div className="flex flex-wrap gap-4 items-center">
          <Button variant="outline">All Dealers</Button>
          <Button variant="outline">Dubai</Button>
          <Button variant="outline">Abu Dhabi</Button>
          <Button variant="outline">Sharjah</Button>
          <Button variant="outline">Luxury Cars</Button>
          <Button variant="outline">Budget Friendly</Button>
        </div>
      </div>
              ...
              <CardHeader>
                  ...
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                      ...
                      {dealer.subscription && (
                        ...
                        >
                          {dealer.subscription.tier?.toUpperCase()} DEALER
                        </Badge>
                      )}
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-500 ml-1">({Math.floor(Math.random() * 200) + 50} reviews)</span>
                  </div>
                </div>
              </CardHeader>
                ...
                <div className="space-y-3">
                  ...
                  <div className="pt-2 border-t">
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">{yearsInBusiness}+</span> years in business
                    </div>
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">{Math.floor(Math.random() * 50) + 10}</span> active listings
                    </div>
                  </div>
      ...
      {dealers.length === 0 && (
        <div className="text-center py-12">
          <h3 className="text-xl font-medium text-gray-900 mb-2">No verified dealers found</h3>
          <p className="text-gray-600">Please run the database seed script to populate dealers.</p>
      ...
      <div className="mt-16 text-center bg-blue-50 rounded-lg p-8">
        ...
        <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
          Join our network of verified dealers and reach thousands of potential customers across the UAE.
        </p>
